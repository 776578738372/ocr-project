"""[5] TIN_SEARCHED -> [5A] EVAL_CHANGE -> [6A]/[6B]/[6C].
...
from w9_onboarding.matching.blocking import generate_candidates
from w9_onboarding.security import hash_identifier
