"""[2B] VLM_EXTRACTION: vision-model extraction for scans, phone photos, and
any PDF without a usable embedded text layer.
...
from w9_onboarding.security import mask_tin, tokenize_tin
