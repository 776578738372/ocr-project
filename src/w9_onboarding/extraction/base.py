"""Shared extractor interface -- [2A] LAYOUT_OCR and [2B] VLM_EXTRACTION both
implement this so the pipeline can call either without caring which one ran.
"""
...
from w9_onboarding.contracts.schema import ExtractedFields, ExtractionPath
...
def missing_value(source: ExtractionPath, evidence: str | None = None):
    from w9_onboarding.contracts.schema import ExtractedValue
