"""The FSM itself: [0] UNINIT -> ... -> [7] TERMINATED.
...
from w9_onboarding.extraction.layout_ocr import LayoutOCRExtractor
from w9_onboarding.extraction.vlm_extraction import MockVLMExtractor, get_vlm_extractor
